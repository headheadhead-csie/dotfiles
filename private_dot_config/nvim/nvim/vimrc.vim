...
autocmd BufEnter Trouble :match none /\s\+$/ "highlight trailing white space
autocmd BufEnter,InsertLeave *\(Trouble\)\@<! :match curSearch /\s\+$/ "highlight trailing white space
